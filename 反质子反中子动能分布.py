...
plt.plot(bins_T_pbar[:-1], numbers_T_pbar, label=r'$\bar{p}$', linewidth=5)
...
#
# # plt.show()
# # plt.savefig(r'D:\学习资料\毕业论文\whu-graduation-thesis-latex\figures\pbar_dndt.png')
# # plt.savefig(r'D:\学习资料\毕业论文\whu-graduation-thesis-latex\figures\pbar_dndt.eps', dpi= 300)
#
# # plt.figure()
#
# plt.subplot(122)
...
plt.show()
plt.savefig(r'D:\学习资料\毕业论文\whu-graduation-thesis-latex\figures\pbarnbar_dndt.png')
plt.savefig(r'D:\学习资料\毕业论文\whu-graduation-thesis-latex\figures\pbarnbar_dndt.pdf')
